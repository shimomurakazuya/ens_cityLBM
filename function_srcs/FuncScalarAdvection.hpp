    ...
    )
{
    ...
    if ( FuncObj::is_obj( lv_obs[id0] ) ) { scalar_n[id0] = f_average( ids, scalar, lv_obs ); return; }
...
//    const real  ww      = (real)0.5;
    ...
    const real coef_vis_sgs   = (sgs_vis[id0]/2.0);
...
//    const real  ww   = (real)0.5;
    ...
    const real  source  = sc_scalar[id0] * dt;
...
//    if ( FuncObj::is_obj( lv_obs[id0] ) ) { scalar_n[id0] = 0.0; return; }
    if ( FuncObj::is_obj( lv_obs[id0] ) ) { scalar_n[id0] = f_average(i,j,k,offset3d, scalar, lv_obs); return; }
    ...
    const real  lv5x[] = { lv_obs[Index::id(i-2, j  , k  , offset3d)], lv_obs[Index::id(i-1, j  , k  , offset3d)], lv_obs[Index::id( i, j, k, offset3d)], lv_obs[Index::id(i+1, j  , k  , offset3d)] , lv_obs[Index::id(i+2, j  , k  , offset3d)] };
    const real  lv5y[] = { lv_obs[Index::id(i  , j-2, k  , offset3d)], lv_obs[Index::id(i  , j-1, k  , offset3d)], lv_obs[Index::id( i, j, k, offset3d)], lv_obs[Index::id(i  , j+1, k  , offset3d)] , lv_obs[Index::id(i  , j+2, k  , offset3d)] };
    const real  lv5z[] = { lv_obs[Index::id(i  , j  , k-2, offset3d)], lv_obs[Index::id(i  , j  , k-1, offset3d)], lv_obs[Index::id( i, j, k, offset3d)], lv_obs[Index::id(i  , j  , k+1, offset3d)] , lv_obs[Index::id(i  , j  , k+2, offset3d)] };
    ...
    )
{
    ...
    if ( FuncObj::is_fluid( lv_obs[ id_tmp ] ) ) { f += scalar[ id_tmp ]; count++; }
