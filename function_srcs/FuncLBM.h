    ...
    )
{
    ...
    // delta : 0 ~ 0.5 ~ 1.0 //
    const real  lv0     = lv_obj[id0];
    const real  lv_up   = lv_obj[id_up];
    const real  lv_down = lv_obj[id_down];
...
//    const real  rb = (real)1.0; // density on boundary //
    ...
    const real  ub = u_obj[id_up];
    const real  vb = v_obj[id_up];
    const real  wb = w_obj[id_up];
//    const real  ub = f_int( u_obj[id0], u_obj[id_up], lv0, lv_up );
//    const real  vb = f_int( v_obj[id0], v_obj[id_up], lv0, lv_up );
//    const real  wb = f_int( w_obj[id0], w_obj[id_up], lv0, lv_up );
