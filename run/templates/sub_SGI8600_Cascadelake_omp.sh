...
#PBS -l select={0[node]}:ncpus={0[nb_cores]}:mpiprocs={0[GPUs_per_node]}:ompthreads={0[NB_THREADS]}:ngpus={0[GPUs_per_node]}
...
module purge 
module load mpt/2.23-ga cuda/11.0; export MPI_USE_CUDA=1
