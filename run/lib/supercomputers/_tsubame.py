...
class Tsubame3(AbstractSupercomputer):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.machine_name = 'Tsubame3.0'
        self.indent_params = 7
        self.default_modules = ['cuda/11.2.146',
                                'gcc/10.2.0-cuda',
                                'openmpi/3.1.4-opa10.10-t3',
                               ]
        self.default_envs = ['PSM2_MQ_RNDV_HFI_THRESH=128000']
    ...
    def __init_run(self):
        ...
        args.append('qsub')
        args.append('-g')
        args.append(f'{self.job_dict["ACCOUNT"]}')
        args.append('job.sh')
        self.args = args
